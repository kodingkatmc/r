      ...
      <div className="content" id="augment">
        ...
        <div className="content_sub">
          <div className="c_left_s">
            ...
            <a className="link center" download="Augment Vanilla v1.10.zip" href={require("./data/datapacks/Augment Vanilla v1.10.zip")}>Download Augment Vanilla</a>
          </div>
      ...
      <div className="content" id="caves">
        ...
        <div className="content_sub">
          <div className="c_left_s">
            ...
            <a className="link center" download="Cave Creation v1.7.zip" href={require("./data/datapacks/Cave Creation v1.7.zip")}>Download Cave Creation</a>
          </div>
          <div className="c_right_l">
      ...
      <div className="content" id="kktools">
        ...
        <div className="content_sub">
          ...
          <div className="c_right_s">
            ...
            <a className="link center" download="Building Tools v2.4.zip" href={require("./data/datapacks/Building Tools v2.4.zip")}>Download Building Tools</a>
          </div>
        </div>
      </div>
      <div className="content" id="dweller">
        ...
        <div className="content_sub">
          <div className="c_left_s">
            ...
            <a className="link center" download="Dweller v1.4.zip" href={require("./data/datapacks/Dweller v1.4.zip")}>Download Dweller</a>
          </div>
          <div className="c_right_l">
      ...
      <div className="content" id="kkwa">
        ...
        <div className="content_sub">
          ...
          <div className="c_right_s">
            ...
            <a className="link center" download="Wolf Armor v1.3.zip" href={require("./data/datapacks/Wolf Armor v1.3.zip")}>Download Wolf Armor</a>
          </div>
        </div>
      </div>
      <div className="content" id="kill">
        ...
        <div className="content_sub">
          <div className="c_left_s">
            ...
            <a className="link center" download="Kill Non-Player Entities v1.6.zip" href={require("./data/datapacks/Kill Non-Player Entities v1.6.zip")}>Download Kill Non-Player Entities</a>
          </div>
          <div className="c_right_l">
